...
--[[
获取兵种的击杀金币奖励(根据等级计算)
V3.4新增: 1级兵就是基础值,2级兵就是金币基础数*2,3级兵就是金币基础数*3,4级兵就是金币基础数*4,5级兵就是金币基础数*5
@param unitId string - 兵种ID
