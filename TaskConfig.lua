...
TaskConfig.Tasks = {
	...
	-- 任务1005: 将3个囚犯布置到战场中
	{
		...
		RequiredCount = 3,
		Description = "Deploy 3 INMATES to the battlefield.",
		RewardCoins = 200,
		Sort = 5,
	},
	-- 任务1006: 完成一场战斗
	...
	-- 任务1007: 购买一次技能
	{
		...
		RequiredCount = 1,
		Description = "Purchase one skill.",
		RewardCoins = 300,
		Sort = 7,
	},
	-- 任务1008: 购买任意一个囚犯
	...
	-- 任务1010: 领取一次挂机奖励
	{
		...
		RequiredCount = 1,
		Description = "Claim one idle earnings reward.",
		RewardCoins = 500,
		Sort = 10,
	},
	-- 任务1011: 合成一个2级菜鸟
	{
		...
		RequiredCount = 1,
		Description = "Merge a Lv.2 Rookie",
		RewardCoins = 800,
		Sort = 11,
